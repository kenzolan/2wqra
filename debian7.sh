...
# set repo
wget -O /etc/apt/sources.list "https://raw.github.com/drcyber96/autoscriptwebmin/master/conf/sources.list.debian7"
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/drcyber96/autoscriptwebmin/master/conf/1194.conf"
...
wget -O /root/mrtg-mem.sh "https://raw.github.com/drcyber96/autoscriptwebin/master/conf/mrtg-mem.sh"
...
curl "https://raw.github.com/drcyber96/autoscriptwebmin/master/conf/mrtg.conf" >> /etc/mrtg.cfg
